...
// hasta aki
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
            ...
            Intent intentNewProposal = new Intent(MainActivity.this, InsertActivity.class);
           ...
           //Intent verContact = new Intent(Intent.ACTION_VIEW,Uri.parse("content://contacts/people/"));
           //startActivity(verContact);

            Intent shareIntent = new Intent(Intent.ACTION_SEND);
            shareIntent.setType("text/plain");
            shareIntent.putExtra(Intent.EXTRA_TEXT, "https://github.com/josemanuelCRV/REPORT-CENTER/tree/master");
            startActivity(Intent.createChooser(shareIntent, "Share link using"));

        } else if (id == R.id.nav_send) {
            Intent contactUs=new Intent(Intent.ACTION_SENDTO, Uri.parse(getString(R.string.emailContactUs)));
            contactUs.putExtra(Intent.EXTRA_SUBJECT, "Contacto desde App");
