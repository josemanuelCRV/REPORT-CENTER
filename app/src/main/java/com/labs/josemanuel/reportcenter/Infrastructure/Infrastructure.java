...
public class Infrastructure {
    ...
    public static void setDummyProposal() {
        try {
            ...
            JSONHandler.setValueJsonObject(dummyProposal,"_links","type",new JSONObject().put("href","http://stag.hackityapp.com/API-js/rest/type/node/proposal"));
            ...
            JSONHandler.setValueJsonArray(dummyProposal,"title","value","Creación de propuesta desde POST");
